    ...
    <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
      ...
      <div class="pt-12 sm:pt-16 lg:pt-20">
        ...
        <div class="mt-6 text-gray-500 space-y-6">
          ...
          <p class="text-base leading-7">
            Zeitplans is a small company located in Boulder Co with a small team at the moment but as we plan our growth over the next five years we will be hiring accordingly.
          </p>
        </div>
      </div>
