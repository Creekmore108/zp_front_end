...
This Privacy Statement explains our practices, including your choices, regarding the collection, use, and disclosure of certain information, including your personal information in connection with the Zeitplans service.
</p>
<h3 class="font-extrabold text-gray-800">Contacting Us<h3>
<p class="text-gray-900 text-base mb-5">
If you have general questions about your account or how to contact customer service for assistance, please visit our online help center at support.Zeitplans.com. For questions specifically about this Privacy Statement, or our use of your personal information, cookies or similar technologies, please contact our Data Administrator by email at privacy@Zeitplans.com.
</p>
<p class="text-gray-900 text-base">
The data controller of your personal information is Zeitplans, Inc. Please note that if you contact us to assist you, for your safety and ours we may need to authenticate your identity before fulfilling your request.
</p>
<h3 class="font-extrabold text-gray-800">Collection of Information</h3>
...
<p class="text-gray-900 text-base">
Information we collect automatically: We collect information about you and your use of our service, your interactions with us and our advertising, as well as information regarding your network, network devices, and your computer or other devices you might use to access our service (such as gaming systems, smart TVs, mobile devices, set top boxes, and other streaming media devices). This information includes:
your activity on Zeitplans services:
...
device IDs or other unique identifiers, including for your network devices, and devices that are Zeitplans capable on your Wi-Fi network; 
...
information collected via the use of cookies, web beacons and other technologies, as well as the date and time).
</p> <br>
<p class="text-gray-900 text-base">
Information from partners: We collect information from other companies with whom you have a relationship (“Partners”). These Partners might include (depending on what services you use): your TV or internet service provider, or other streaming media device providers who make our service available on their device; mobile phone carriers or other companies who provide services to you and collect payment for the Zeitplans service for distribution to us or provide pre-paid promotions for the Zeitplans service; and voice assistant platform providers who enable interaction with our service through voice commands. The information Partners provide us varies depending on the nature of the Partner services, and may include:
service activation information such as your email address or other contact information;
IP addresses, device IDs or other unique identifiers, as well as associated pre-paid promotion, billing and user interface information, that support user authentication, the Zeitplans service registration experience and Partner payment processing.
...
security service providers who provide us with information to secure our systems, prevent fraud and help us protect the security of Zeitplans accounts;
...
<p class="text-gray-900 text-base">
determine your ISP to support network troubleshooting for you (we also use aggregated ISP information for operational and business purposes), and help us quickly and efficiently respond to inquiries and requests;
coordinate with Partners on making the Zeitplans service available to members and providing information to non members about the availability of the Zeitplans service, based on the specific relationship you have with the Partner;
secure our systems, prevent fraud and help us protect the security of Zeitplans accounts;
prevent, detect and investigate potentially prohibited or illegal activities, including fraud, and to enforce our terms (such as determining whether and for which Zeitplans signup offers you are eligible; 
...
communicate with you concerning our service so that we can send you news about Zeitplans, details about new features and content available on Zeitpalans, special offers, promotional announcements, consumer surveys, and to assist you with operational requests such as password reset requests. These communications may be by various methods, such as email, push notifications, text message, online messaging channels, and matched identifier communications. 
</p>
<p class="text-gray-900 text-base">
...
“Remember me” function: For ease of access to your account, you can use the "Remember me on this device" function when you log in to the website. This function uses technology that enables us to provide direct account access and to help administer the Zeitplans service without requiring reentry of any password or other user identification when your browser revisits the service.

Profiles: Profiles allow users to have a distinct, personalized Zeitplans experience. Please note that profiles are available to everyone who uses your Zeitplans account, so that anyone with access to your Zeitplans account can navigate to and use, edit or delete profiles. You should explain this to others with access to your account.
...
When you visit the "Account" portion of our website, you have the ability to access and update a broad range of information about your account, including your contact information, your Zeitplans payment information, and various related information about your account (such as the content you have viewed and rated). You must be signed in to access the "Account" section.

If you are the account owner, to download a copy of your personal information go to: www.Zeitplans.com/account/getmyinfo (you must be signed in to access the "Account" section), and follow the instructions.

For other requests, or if you have any other question regarding our privacy practices, please contact our Data Protection Officer/Privacy Office at privacy@Zeitplans.com. For more information about how to access your information, including our verification process, please reference this help article: help.Zeitplans.com/node/100624. For information about deletion, removal and retention of information, please reference this help article: help.Zeitplans.com/node/100625. We respond to all requests we receive from individuals wishing to exercise their data protection rights in accordance with applicable data protection laws. Please also see the "Your Choices" section of this Privacy Statement for additional choices regarding your information.
...
If you are a California consumer, please see our California Consumer Privacy Act (CCPA) Privacy Notice by clicking on the link, going to help.Zeitplans.com/legal/privacy#ccpa or simply scrolling down.
...
Performance and functionality cookies: These cookies help us to customize and enhance your online experience with Zeitplans. For example, they help us to remember your preferences and prevent you from needing to re-enter information you previously provided (for example, during member sign up). We also use these cookies to collect information (such as popular pages, conversion rates, viewing patterns, click-through and other information) about our visitors' use of the Zeitplans service so that we can enhance and personalize our website and service and conduct market research. Deletion of these types of cookies may result in limited functionality of our service.
...
<p class="text-gray-900 text-base">
To opt out of interest-based ads from Zeitplans in connection with an resettable device identifier on a mobile device, tablet, or streaming media devices, please configure the appropriate setting on your device (usually found under "privacy" or "ads" in your device's settings). You may still see Zeitplans ads on your device, but they will not be tailored to your likely interests.
To exercise choice using self-regulatory program resources
</p>
<p class="text-gray-900 text-base">
Zeitplans supports the following self-regulatory programs, which provide additional privacy choices for interest-based advertising:
...
<h4 class="text-gray-700">Personal Information We Collect<h4>
<p class="text-gray-900 text-base">
...
<p class="text-gray-900 text-base">
determine your general geographic location, provide localized content, determine your Internet service provider, and help us quickly and efficiently respond to inquiries and requests;
to coordinate with Partners on making the Zeitplans service available to members and providing information to non members about the availability of the Zeitplans service, based on the specific relationship you have with the Partner; 
prevent, detect and investigate potentially prohibited or illegal activities, including fraud, and to enforce our terms; 
analyze and understand our customers, improve our service (including our user interface experiences) and optimize content selection, recommendation algorithms and delivery; 
communicate with you concerning our service so that we can send you news about Zeitplans, details about new features and content available on Zeitplans, special offers, promotional announcements, consumer surveys, and to assist you with operational requests such as password reset requests. These communications may be by various methods, such as email, push notifications, text message, online messaging channels. 
Categories of CCPA personal information disclosed for a business purpose
</p>
<p class="text-gray-900 text-base">
We disclose the categories of CCPA personal information listed below for business purposes. 
</p><br>
<p class="text-gray-900 text-base">
...
<p class="text-gray-900 text-base">
If you are a consumer under the CCPA and wish to contact us through an authorized agent, the authorized agent can submit a request on your behalf at privacy@Zeitplans.com along with a statement signed by you certifying that the agent is authorized to act on your behalf. In order to verify the request and your identity, we may ask you to verify your identity. For more information about how to access your information, including our verification process, .
</p>
<p class="text-gray-900 text-base">
If you do not own a Zeitplans account, we may not be able to respond to requests to exercise rights under CCPA, including the right to know or delete CCPA personal information. Because we only collect limited information about individuals without an account, we are unable to verify requests from non-accountholders to the standard required by the CCPA.
</p>
