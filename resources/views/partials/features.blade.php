<section id="features" class="mt-3">
    <div class="bg-gradient-to-r from-yellow-600 to-yellow-800 rounded-2xl" >
      <div class="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
        ...
        <h2 class="font-extrabold text-4xl text-gray-600 tracking-tight mt-0">
        ...
        <p class="mt-4 max-w-3xl text-lg text-white">
          ...
          <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
            ...
            <x-icon-box title="Scheduling Waitlists" text="Wait lists allow users to signup and be notified in the instance a resource that had already been scheduled by another user becomes availble during the time the wanted to used it. This increases the utilization of your resources during times of high demand and keeps your memebers happy.">
            ...
            <x-icon-box title="Internal Chat" text="We understand there are many channels to communicate in this day and age but we added an internal chat system so if you are online looking to schedule a resource and you see another member who is online as well you can connect straight away.">  
              <x-icon.chat class="text-white" />
            </x-icon-box>

            <x-icon-box title="System Administration" text="
                  Add, update and delete resources, 
                  Manage member accounts, 
                  Manage the Class Postings,
