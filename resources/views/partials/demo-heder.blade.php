...
<div class="h-screen flex overflow-hidden bg-cool-gray-100" x-data="{ sidebarOpen: false }" @keydown.window.escape="sidebarOpen = false">
        ...
        <div x-show="sidebarOpen" class="md:hidden" style="display: none;">
            <div class="fixed inset-0 flex z-40">
                ...
                <div x-show="sidebarOpen" x-description="Off-canvas menu, show/hide based on off-canvas menu state." x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="relative flex-1 flex flex-col max-w-xs w-full bg-indigo-800" style="display: none;">
                    ...
                    <div class="flex-1 h-0 pt-5 overflow-y-auto w-24 bg-yellow-500">
                        <div class="flex-shrink-0 flex px-4  bg-red-500 w-48">
                            <img class="h-8 w-auto" src="/img/logo.svg" alt="Zeitplans">
                        </div>
        ...
        <div class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64 border-r border-gray-200 bg-gray-600" >
                <div class="flex-1  flex flex-col pt-3 overflow-y-auto bg-gray-600">
                    <a href="/dashboard">
                        <div class="flex content-center place-content-center">
                            <img class="h-20 w-auto" src="/img/logo.svg" alt="Zeitplans">
                        </div>
                    </a>
                    <!-- Sidebar component, swap this element with another sidebar if you like -->
                    <nav class="mt-3 space-y-1 flex-1 px-2  bg-blue-gray">
                        <a href="/" class="hover:no-underline group flex items-center px-2 py-2 text-sm leading-5 font-medium  rounded-md text-black bg-gradient-to-r from-yellow-600 to-yellow-800 hover:text-white hover:from-yellow-800 hover:to-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600 focus:outline-none focus:border-yellow-800 focus:ring ring-yellow-800 disabled:opacity-25 transition ease-in-out duration-150">
                            <x-icon.home class="mr-3 h-6 w-6 text-white"></x-icon.home>
                            Dashboard
                        </a>
                        <a href="/scheduled_resources" class="hover:no-underline group flex items-center px-2 py-2 text-sm leading-5 font-medium  rounded-md text-black bg-gradient-to-r from-yellow-600 to-yellow-800 hover:text-white hover:from-yellow-800 hover:to-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600 focus:outline-none focus:border-yellow-800 focus:ring ring-yellow-800 disabled:opacity-25 transition ease-in-out duration-150">
                            <x-icon.calendar class="mr-3 h-6 w-6 text-white"></x-icon.calendar>
                            Resources
                        </a>
                        <a href="/classes" class="hover:no-underline group flex items-center px-2 py-2 text-sm leading-5 font-medium  rounded-md text-black bg-gradient-to-r from-yellow-600 to-yellow-800 hover:text-white hover:from-yellow-800 hover:to-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600 focus:outline-none focus:border-yellow-800 focus:ring ring-yellow-800 disabled:opacity-25 transition ease-in-out duration-150">
                            <x-icon.classes class="mr-3 h-6 w-6 text-white"></x-icon.classes>     
                            Classes
                        </a>
                        <a href="/meetings" class="hover:no-underline group flex items-center px-2 py-2 text-sm leading-5 font-medium  rounded-md text-black bg-gradient-to-r from-yellow-600 to-yellow-800 hover:text-white hover:from-yellow-800 hover:to-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600 focus:outline-none focus:border-yellow-800 focus:ring ring-yellow-800 disabled:opacity-25 transition ease-in-out duration-150">
                            <x-icon.meetings class="mr-3 h-6 w-6 text-white"></x-icon.meetings>
                            Meetings
                        </a>
                        <a class="hover:no-underline group flex items-center px-2 py-2 text-sm leading-5 font-medium  rounded-md text-black bg-gradient-to-r from-yellow-600 to-yellow-800 hover:text-white hover:from-yellow-800 hover:to-yellow-600 focus:outline-none  focus:ring-1 focus:ring-yellow-800 focus:border-yellow-600 focus:outline-none focus:border-yellow-800 focus:ring ring-yellow-800 disabled:opacity-25 transition ease-in-out duration-150">
                ...
                @if((Auth::user()))
                <nav class="mt-3 space-y-1 flex-1 px-2 bg-indigo-800">
                        <a  class="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-white rounded-md bg-indigo-900 focus:outline-none focus:bg-indigo-700 transition ease-in-out duration-150">
                            <x-icon.gear></x-icon.gear>
                            Admin
                        </a>
                        <a  class="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-white rounded-md bg-indigo-900 focus:outline-none focus:bg-indigo-700 transition ease-in-out duration-150">
                            <x-icon.folder></x-icon.folder>
                            Resource Admin
                        </a>
                        <a  class="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-white rounded-md bg-indigo-900 focus:outline-none focus:bg-indigo-700 transition ease-in-out duration-150">
